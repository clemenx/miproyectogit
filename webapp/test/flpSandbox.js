		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#miproyectogit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"miproyectogit-display": {
								"semanticObject": "miproyectogit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=miproyectogit",
									"url": sap.ui.require.toUrl("miproyectogit")
								}
							}
						}
					}
